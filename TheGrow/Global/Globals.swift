...
class Globals
{
    ...
    public static func dateSplit(dateInString:String)-> String {
        let splitDateAndTime = dateInString.split(separator: " ")
        let time = splitDateAndTime[1]
        return checkAmOrPm(time: String(time))
    }
    public static func checkAmOrPm(time:String) -> String {
